...
####This script is copied into the end of install_sql_server_principal-step_1.ps1
...
Write-Log "Looking for scripts in $script_bucket in initial-alwayon-startup-script"
