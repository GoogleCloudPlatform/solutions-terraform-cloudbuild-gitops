...
def security_ctf_admin(request):
    ...
    project_roles = ["iam.securityReviewer", "securitycenter.adminViewer", "compute.viewer", "storage.legacyBucketReader", "storage.legacyObjectReader", "bigquery.dataViewer", "bigquery.user", "dlp.reader", "monitoring.viewer"]
